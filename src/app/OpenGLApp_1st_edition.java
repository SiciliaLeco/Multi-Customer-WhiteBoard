...
public class OpenGLApp_1st_edition extends JFrame {
	/**
	 * 
	 */
	...
	sketchPanel_1st_edition canvas = new sketchPanel_1st_edition();
	Graphics gg = canvas.getGraphics();
	Color lined_color, filled_color;
	

	
	public void addShapetoSet(Shape s) {
		ga.add(s);
...
//						rec_tri = 2;
	...
	public static void main(String []args) {
		OpenGLApp_1st_edition frame = new OpenGLApp_1st_edition();
